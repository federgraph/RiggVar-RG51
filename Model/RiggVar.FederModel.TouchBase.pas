...
procedure TTouchBtn.SetColor(Value: TColor);
begin
...
procedure TTouchBtn.SetHint(const Value: TTranslateString);
begin
  if Assigned(FText) then
  begin
    FText.Hint := Value;
...
begin
  ...
  begin
    ...
    ToolBtn.Left := MainVar.Raster;
    ToolBtn.Top := MainVar.Raster;
