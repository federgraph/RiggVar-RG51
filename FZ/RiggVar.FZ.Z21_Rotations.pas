...
begin
  ...
  Origin.StrokeColor := CssOrange;

  LAX.StrokeColor := CssRed;
  LAY.StrokeColor := CssGreen;
  LAZ.StrokeColor := CssBlue;
end;

procedure TRggDrawingZ21.GoDark;
begin
  inherited;
  AX.StrokeColor := CssOrangered;
  AY.StrokeColor := CssSeagreen;
  AZ.StrokeColor := CssDodgerBlue;

  Origin.StrokeColor := CssGoldenrod;

  LAX.StrokeColor := CssOrangered;
  LAY.StrokeColor := CssSeagreen;
  LAZ.StrokeColor := CssDodgerblue;
end;
