...
type
  ...
  public
    ...
    procedure DrawLegend(g: TBGRABitmap; j: Integer);
  ...
  public
    function Compare(constref Left, Right: TDisplayItem): Integer;
  end;
  ...
  public
    ...
    procedure Line(const Name: string; EdgeName: TDisplayEdge; P1, P2: TPoint3D; A, B: TPointF; Color: TBGRAPixel);
    procedure PolyLine(const Name: string; EdgeName: TDisplayEdge; P1, P2: TPoint3D; A: ArrayOfTPointF; Color: TBGRAPixel);
    procedure Draw(Canvas: TBGRABitmap);
    procedure Draw1(Canvas: TBGRABitmap);
    procedure Draw2(Canvas: TBGRABitmap);
...
procedure TDisplayItem.DrawLegend(g: TBGRABitmap; j: Integer);
var
  x, y, w, h: Integer;
  R: TRectF;
begin
  ...
  R := RectF(x, y, x + w, (j + 1) * h);

  g.RectangleAntialias(R.Left, R.Top, R.Right, R.Bottom, CssBlue, 1, StrokeColor);

  g.FontName := 'Courier New';
  g.FontHeight := 13;
  g.TextOut(x + 10, y + 3, Name, BGRABlack);
end;

procedure TDisplayItem.Draw(g: TBGRABitmap);
begin
  case ItemType of
    diLine:
    begin
    ...
    diPolyLine:
    begin
      g.DrawPolyLineAntialias(Polygon, StrokeColor, StrokeWidth);
    end;
...
procedure TRggDisplayList.Line(const Name: string; EdgeName: TDisplayEdge; P1, P2: TPoint3D; A, B: TPointF; Color: TBGRAPixel);
var
  cr: TDisplayItem;
begin
  IL.Add(Name);
...
procedure TRggDisplayList.PolyLine(const Name: string; EdgeName: TDisplayEdge; P1, P2: TPoint3D; A: ArrayOfTPointF; Color: TBGRAPixel);
var
  cr: TDisplayItem;
begin
  IL.Add(Name);
...
procedure TRggDisplayList.Draw(Canvas: TBGRABitmap);
begin
  if DF = nil then
  begin
    Draw1(Canvas)
...
procedure TRggDisplayList.Draw2(Canvas: TBGRABitmap);
var
  de: TDisplayEdge;
  cr: TDisplayItem;
  j: Integer;
...
procedure TRggDisplayList.Draw1(Canvas: TBGRABitmap);
var
  cr: TDisplayItem;
  j: Integer;
begin
...
function TDisplayItemComparer.Compare(constref Left, Right: TDisplayItem): Integer;
begin
