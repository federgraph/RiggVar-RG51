...
begin
  ...
  ListViewDetails.Left := 176;
  ListViewDetails.Top := 88;
  ListViewDetails.Width := 305;
  ...
  ListViewGroups.Left := 752;
  ListViewGroups.Top := 88;
  ListViewGroups.Width := 225;
  ...
  TextSearchResult.Left := 16;
  TextSearchResult.Top := 120;
