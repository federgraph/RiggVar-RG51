...
type
  ...
  public
    YLEDFillColor: TBGRAPixel;
    PLEDFillColor: TBGRAPixel;
    XLEDFillColor: TBGRAPixel;
  ...
  public
    ...
    cf: array[0..PNr-1] of TBGRAPixel;
    ChartPunktX: double;
...
begin
  FAP := Value;
  XLEDFillColor := CssYellow;
  PLEDFillColor := CssYellow;
  UpdateXMinMax;
  UpdatePMinMax;
end;
