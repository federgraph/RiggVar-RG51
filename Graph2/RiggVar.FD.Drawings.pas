...
type
  ...
  public
    function Compare(constref Left, Right: TRggCircle): Integer;
  end;

  TRggLineComparer = class(TInterfacedObject, IComparer<TRggLine>)
  public
    function Compare(constref Left, Right: TRggLine): Integer;
  end;
  ...
  private
    ...
    procedure SortedDraw(g: TBGRABitmap);
...
procedure TRggDrawing.Draw(g: TBGRABitmap);
begin
  if WantSort then
    SortedDraw(g)
  else
...
procedure TRggDrawing.UnsortedDraw(g: TBGRABitmap);
var
  e: TRggElement;
begin
...
function TRggLineComparer.Compare(constref Left, Right: TRggLine): Integer;
begin
...
function TRggCircleComparer.Compare(constref Left, Right: TRggCircle): Integer;
begin
