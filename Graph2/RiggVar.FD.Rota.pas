...
type
  ...
  private
    ...
    procedure SetBackgroundColor(const Value: TBGRAPixel);
  protected
    MouseDown: Boolean;
    MousePos: TPointF;
    TH: TTransformHelper;
...
procedure TRotaForm2.SetBackgroundColor(const Value: TBGRAPixel);
begin
...
begin
  ...
  TH.DoOnMouse(Shift, Round(dx), Round(dy));
...
procedure TRotaForm2.DrawToCanvas(g: TBGRABitmap);
begin
  Inc(DrawCounter);
